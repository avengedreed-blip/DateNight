...
export default function App() {
  ...
  const remoteModeInitializedRef = useRef(false);
  ...
  useEffect(() => {
    if (!db || !gameId || !mode || !remoteModeInitializedRef.current) {
      return;
    }
