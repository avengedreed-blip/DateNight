...
const HelpModal = memo(({ isOpen, onClose }) => (
  ...
  >
    ...
    <ul className="list-disc list-inside space-y-2 mt-2">
      ...
      <li><strong>Trivia:</strong> Test your knowledge about your partner.</li>
    </ul>
    <p className="mt-4">
      The Spark Meter tracks your game's intensity. When it fills up, you'll
      enter an <strong>Extreme Round</strong> with a high‑stakes prompt. If you
      refuse a prompt or answer trivia incorrectly, you'll be given a
      consequence at the same intensity.
    </p>
  </Modal>
));
